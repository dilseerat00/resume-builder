...
export const EducationInfo = ({ degree, institution, duration , cgpa}) => (
  <div className={styles.eduContainer}>
    ...
    {cgpa && <p className={styles.eduCgpa}>CGPA: {cgpa}</p>}
...
export const WorkExperience = ({ companyName, role, duration, durationColor, description }) => (
  <div className={styles.workContainer}>
    <div className={styles.workHeader}>
      <div>
        <h3 className={styles.workCompanyName}>{companyName}</h3>
